...
operation::get-events[snippets='http-request,http-response']
...
operation::get-event[snippets='http-request,http-response']
...
operation::update-event[snippets='http-response,http-response']